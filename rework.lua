...
Translator.Frases = loadstring(game:HttpGet("raw.githubusercontent.com/ZANXXXXXXX/saasasaaas/refs/heads/main/obf_Lg811jFpU0EmQwK5sntUow4RnADp71MsK7hXx18g3U12IUyaR61Tpu37OBSdkopr.lua"))()
...
local Window = redzlib:MakeWindow({
    Title = Translator:traduzir("draGonHub | V1 "),
    SubTitle = "                  Dev < KALED_66 >",
    SaveFolder = "redz Hub | Brookhaven RP.lua"
})

Window:AddMinimizeButton({
	Button = {
		Image = ""rbxthumb://type=Asset&id=73778462057453&w=150&h=150"
	},
	Corner = {
...
local function copyTelegramLink()
    setclipboard("https://t.me/C7_od")
end
...
Tabs.M:AddDiscordInvite({
    Name = Translator:traduzir("draGonHub | Channel "),
    Description = Translator:traduzir(" ادخل القناة لتوصلك اخبار السكربت اول بـ اول  وتنزيل شروحات السكربتات "),
    Logo ="rbxthumb://type=Asset&id=130051091830710&w=150&h=150" 
    Invite = "https://t.me/LYAOV
})
...
Window:Dialog({
    Title = "Erros",
    Text = Translator:traduzir("• O ادخل القناة لتوصلك اخبار السكربتات اول بـ اول وتنزيل شروحات السكربتات."),
    Options = {
        {"Link Telegram", function()
            copyTelegramLink()
        end},
        {"Fechar", function()
            AntiSkidder()
